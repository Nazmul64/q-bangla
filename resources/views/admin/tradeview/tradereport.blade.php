                  ...
                  <div class="mt-2">
                             <table class="table table-bordered table-hover responsive table-striped">
                                <thead style="background:#64C5B1;">
                                    ...
                                    <th scope="col"class="text-white">Buyer UserID</th>
                                    <th scope="col"class="text-white">Buyer Full Name</th>
                                    <th scope="col"class="text-white">Buyer Contact No</th>
                                ...
                                <tfoot>
                                    <tr>
                                        <th colspan="3" style="align:left;">Total Records : 17 </th>
