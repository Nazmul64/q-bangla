    ...
    <div class="account-box  mb-12">
        ...
        <div class="account-content ">
            <form method="POST" action="{{ route('teamRegister') }}">
                ...
                <div class="form-group row">
                    <div class="col-12">
                        <label for="emailaddress"> Select Country</label>
                ...
                <div class="form-group row">
                    <div class="col-12">
                        <label for="emailaddress">Choose User Name<span class="text-danger">*</span></label>
                        <input class="form-control  @error('text') is-invalid @enderror " type="text"
                            id="text" name="user_name" placeholder="Enter Your Choose User">
                        @error('user_name')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    <div class="col-12">
                        ...
                        <input class="form-control @error('sponsor_id') is-invalid @enderror " type="text"
                            ...
                            value="{{ isset($_GET['sponsor_id']) ? $_GET['sponsor_id'] : '' }}"
                        >
                ...
                <div class="form-group row">
                    <div class="col-12">
                        ...
                        <input class="form-control @error('placement_id') is-invalid @enderror " type="text"
                            ...
                            value="{{ isset($_GET['placement_id']) ? $_GET['placement_id'] : '' }}"
                        >
                        @error('placement_id')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                ...
                <div class="form-group row">
                    ...
                    <select class="form-select form-control" aria-label="Default select example" name="position_set">
                        <option value="right" {{ isset($_GET['position_set']) && $_GET['position_set'] == 'right' ? 'selected' : '' }}>Placement  Right Side</option>
                        <option value="left" {{ isset($_GET['position_set']) && $_GET['position_set'] == 'left' ? 'selected' : '' }}>Placement  left Side</option>
                    </select>
                        @error('position_set')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
            ...
            <div class="row mt-4 pt-2">
                <div class="col-sm-12 text-center">
                    <p class="text-muted mb-0">Don't have an account? <a href="{{ route('login') }}"
